...
class RAVDESS(RawAudioDataset):
    def __init__(self, dataset_name, dataset_path):
        ...
        self.classes = ["01", "02", "03", "04", "05", "06", "07", "08"]
        self.classes_map = {"01":"neutral", "05":"anger", "07":"disgust", "04":"sadness", "03":"happiness", "06":"fear", "08":"surprise"}
    ...
    def get_label_from_fname(self, fpath):
        fname = fpath.split("/")[-1]
        return self.classes_map[fname.split("-")[2].lower()]
    ...
    def get_gemini_instruction_format_data(self, gemini_predictions):
        ...
        all_files = []
        logging.info("Creating gemini instruction data for RAVDESS...")
