...
class EmovDB(RawAudioDataset):
    def __init__(self, dataset_name, dataset_path):
        ...
        self.classes = ["amused", "anger", "disgust", "sleepiness", "neutral"]
        self.classes_map = {"amused":"happiness", "anger":"anger", "disgust":"disgust", "sleepiness":"sleepiness", "neutral":"neutral"}
    ...
    def get_label_from_fname(self, fpath):
        fname = fpath.split("/")[-1]
        return self.classes_map[fname.split("_")[0].lower()]
