...
from avere.constants import DEFAULT_IMAGE_TOKEN
from avere.conversation import conv_templates, SeparatorStyle, Conversation
from avere.serve.gradio_utils import Chat, tos_markdown, learn_more_markdown, title_markdown, block_css
...
# uvicorn avere.serve.gradio_web_server:app
# python -m  avere.serve.gradio_web_server
