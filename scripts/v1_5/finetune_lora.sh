...
HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 deepspeed avere/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter ./checkpoints/avere-7b-pretrain/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir ./checkpoints/avere-7b-lora \
    --num_train_epochs 1 \
